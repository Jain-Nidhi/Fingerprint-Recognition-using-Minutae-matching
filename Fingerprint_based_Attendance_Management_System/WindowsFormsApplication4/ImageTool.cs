...
namespace ImageComparison
{
    ...
    public static class ImageTool
    {
        ...
        public static Bitmap call1(Image img1, Image img2)
        {
            
            Bitmap bmp1 = GetDifferenceImage(img1,img2, true,true);
            return bmp1;
        }

        public static int call2(Image img1, Image img2)
        {

            int count = GetDifferenceImage1(img1, img2, true, true);
            return count;
        }

        public static int GetDifferenceImage1(Image img1, Image img2, bool adjustColorSchemeToMaxDifferenceFound = false, bool absoluteText = false)
        {
            int cellsize = 16;
            ...
            //each tile is 16 pixels wide and high
        ...
        public static Bitmap GetDifferenceImage(Image img1, Image img2, bool adjustColorSchemeToMaxDifferenceFound = false, bool absoluteText = false)
        {
            int cellsize = 16;
            Bitmap bmp = new Bitmap(16 * cellsize + 1, 16 * cellsize + 1); //16 blocks * 16 pixels + a borderpixel at left/bottom
    ...
    return bmp;
        ...
        public static Bitmap GetGrayScaleVersion(this Image original)
        {
            //http://www.switchonthecode.com/tutorials/csharp-tutorial-convert-a-color-image-to-grayscale
        ...
        public static Bitmap Resize(this Image originalImage, int newWidth, int newHeight)
        {
            ...
            Bitmap smallVersion = new Bitmap(newWidth, newHeight);
        ...
        public static float GetPercentageDifference(string image1Path, string image2Path, byte threshold = 3)
        {
            if (CheckFile(image1Path) && CheckFile(image2Path))
            {
                ...
                return PercentageDifference(img1,img2, threshold);
            }
            else return -1;
